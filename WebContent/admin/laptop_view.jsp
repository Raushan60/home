            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Laptop Statement</h4>
                                <p class="category">
                                <br></br>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                 ...
                                 PreparedStatement ps1=conn.prepareStatement("select laptop.name,laptop.email,laptop.phoneno,laptop.state,laptop.city,laptop.feedback,laptop_reply.reply from laptop,laptop_reply where laptop_reply.number=laptop.phoneno");
                                 ...
                                 <td><%=rs2.getString(7)%></td>
                                  <td><a href="dell.jsp">Delete</a></td>
