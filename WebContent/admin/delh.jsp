...
Connection con =DriverManager.getConnection("jdbc:mysql://localhost:3306/feedback","root","ankit");
	 PreparedStatement ps=con.prepareStatement("DELETE FROM home_appliances WHERE phoneno= +phoneno LIMIT 1");
			 ...
			 if(i > 0) {
				...
				<tr><a href="/home/admin/home_appliances_view.jsp">view</a></tr>
				</tr>
				</table>
